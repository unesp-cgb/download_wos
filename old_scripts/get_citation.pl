...
while( $id_list[0] ){
   ...
   my $search_request = qq{<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:woksearch="http://woksearch.v3.wokmws.thomsonreuters.com">\n}.
                        qq{  <soapenv:Header/>\n}.
                        qq{    <soapenv:Body>\n}.
                        qq{      <woksearch:citingArticles>\n}.
      ...
      $search_request .= qq{        </retrieveParameters>\n};
      $search_request .= qq{     </woksearch:citingArticles>\n};
      ...
      open( $target_file , '>' , "/exlibris/aleph/a22_1/alephm/wok_search/records/wos_citations_$file_count.xml");
